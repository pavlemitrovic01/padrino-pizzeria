...
**Poslednji završen:** B13 — Mrtvi fajlovi cleanup (2026-05-16) — no-op
...
15 batches completed (B1 no-op, B2 audit, B3 schema baseline,
...
B7 Menu.tsx image resolver dedup, B9 AuthProvider removal, B13 Mrtvi fajlovi no-op). Plus pre-B7 housekeeping commit 16a6f0f
